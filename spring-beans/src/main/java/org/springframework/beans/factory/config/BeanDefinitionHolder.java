...
public class BeanDefinitionHolder implements BeanMetadataElement {
	 ...
	 * @param beanDefinition the BeanDefinition to wrap 要包装的bean定义
	 * @param beanName the name of the bean, as specified for the bean definition bean的名称，为bean定义指定
	 */
	...
	/**
	 * Create a new BeanDefinitionHolder. 创建一个新的BeanDefinitionHolder。
	 * @param beanDefinition the BeanDefinition to wrap 要包装的bean定义
	 * @param beanName the name of the bean, as specified for the bean definition bean的名称，为bean定义指定
	 * @param aliases alias names for the bean, or {@code null} if none bean的别名，或{@code null}(如果没有)
	 */
