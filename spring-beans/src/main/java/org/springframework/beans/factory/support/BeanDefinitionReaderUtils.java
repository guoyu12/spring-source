...
public abstract class BeanDefinitionReaderUtils {
	...
	/**
	 * 将给定bean定义注册到给定bean工厂。
	 * Register the given bean definition with the given bean factory.
	 * @param definitionHolder the bean definition including name and aliases bean定义包括名称和别名
	 * @param registry the bean factory to register with 要注册的bean工厂
	 * @throws BeanDefinitionStoreException if registration failed 如果注册失败了
	 */
	public static void registerBeanDefinition(
		...
		// Register aliases for bean name, if any. 注册bean名称的别名(如果有的话)。
